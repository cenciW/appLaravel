...
use App\Http\Requests\StatusTaskFormRequest;
use App\Models\StatusTask;
use App\Services\StatusTaskServiceInterface;
use Illuminate\Http\Request;

class StatusTaskRestController extends Controller
{
    private $service;

    public function __construct(StatusTaskServiceInterface $service)
    {
     ...
     */
    public function store(StatusTaskFormRequest $request)
    {
